defmodule BeamMePrompty.IntegrationAgents.Gemini.AgentWithMemory do
  @moduledoc "Gemini agent with memory but without tools or structured responses"
  use BeamMePrompty.Agent

  memory do
    memory_source :short_term, BeamMePrompty.Agent.Memory.ETS,
      description: "Short-term memory storage for Gemini agent",
      opts: [
        table: :gemini_agent_memory
      ],
      default: true
  end
